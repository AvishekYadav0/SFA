...
rep.get('/collections',        rc.collectionReport);
rep.get('/visit',              rc.visitReport);
rep.get('/outstanding',        rc.outstandingReport);
rep.get('/target-achievement', rc.targetAchievement);
rep.get('/lifting',           rc.liftingReport);
rep.get('/product-wise',      rc.productWiseSales);
rep.get('/province-wise',     rc.provinceWiseSales);
rep.get('/monthly-sales',     rc.monthlySalesReport);
rep.get('/dealer-hierarchy',  rc.dealerHierarchy);
rep.get('/order-status',      rc.orderStatus);
rep.get('/staff-hierarchy',   rc.staffHierarchy);
rep.get('/dealer/:id/stats',   rc.dealerStats);
rep.get('/dealer-stock',       rc.dealerStockReport);
rep.get('/stock-movement',     rc.stockMovementReport);
rep.get('/low-stock',          rc.lowStockReport);
rep.get('/dealer-sales-stock', rc.dealerSalesStockReport);
rep.get('/damage-expiry',      rc.damageExpiryReport);
exports.reports = rep;
